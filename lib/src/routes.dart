...
abstract class DescopeAuth {
  ...
  /// or is about expire.
  Future<DescopeSession> refreshSession(String refreshJwt);
...
abstract class DescopeOtp {
  ...
  /// send the [code]. Upon successful authentication a [DescopeSession] is returned.
  Future<DescopeSession> verify({required DeliveryMethod method, required String loginId, required String code});
...
abstract class DescopeTotp {
  ...
  ///
  /// Returns a [DescopeSession] if the provided [loginId] and the [code]
  /// generated by an authenticator app match.
  Future<DescopeSession> verify({required String loginId, required String code});
}
...
abstract class DescopePassword {
  ...
  /// Returns a [DescopeSession] upon successful authentication.
  Future<DescopeSession> signUp({required String loginId, required String password, User? user});

  /// Authenticates an existing user using a password.
  ///
  /// Matches the provided [loginId] and [password].
  /// Returns a [DescopeSession] upon successful authentication.
  Future<DescopeSession> signIn({required String loginId, required String password});
...
abstract class DescopeMagicLink {
  ...
  Future<DescopeSession> verify({required String token});
}
...
abstract class DescopeEnchantedLink {
  ...
  Future<DescopeSession> checkForSession({required String pendingRef});
  ...
  Future<DescopeSession> pollForSession({required String pendingRef, Duration? timeout});
}
...
abstract class DescopeOAuth {
  ...
  /// parameter for a [DescopeSession].
  Future<DescopeSession> exchange({required String code});
}
